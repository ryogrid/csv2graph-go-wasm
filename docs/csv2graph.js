 ...
 * @returns {any}
 */
export function generate_plot_rust(csv_content, options_json) {
    try {
        ...
        wasm.generate_plot_rust(retptr, ptr0, len0, ptr1, len1);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('csv2graph_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
